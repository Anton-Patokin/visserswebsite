...
<div class="row">
    <div class="col-xs-12 col-sm-5 col-md-6 col-lg-6" ng-init="show_exampale=3">
        <div ng-click="gotoStep(2);putValue('news')" class="well text" ng-class="{'show-arrow':showArrow1}" ng-mouseover="showArrow1=true;show_exampale=1" ng-mouseleave="showArrow1=false">Een artikel
        ...
        <div ng-click="gotoStep(2);putValue('contest')" class="well" ng-class="{'show-arrow':showArrow3}" ng-mouseover="showArrow3=true;show_exampale=3" ng-mouseleave="showArrow3=false">
            Een visser plekje
            <span  class="arrow pull-right"></span>
        </div>
    </div>
