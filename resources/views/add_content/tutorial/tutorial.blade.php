@extends('layouts.app')
@section('content')
    <div class="container" ng-init="initTutorialCategory('{{ old('titel') }}','{{ old('inleiding') }}','{{ (old('category')?old('category'):strtolower($tutorialCategory->first()->category)) }}')">
                    ...
                    <div class="col-lg-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption margin-top-5">
                                <h4>Hoe knop je lijn rond de hak?</h4>
                                <p>a period of instruction given by a university or college tutor to an individual or
                                    very small group.
                                    Some lectures and tutorials at Auckland University were cancelled this week when
                                    about half of the academic staff went on strike.</p>
                                <p><a href="" class=" btn-xs" role="button">Meer</a></p>
                            </div>
                        </div>
                        <ul class="list-inline text-center margin-top-1">
